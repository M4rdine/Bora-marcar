...
function tokenize(d: string): { readonly cmd: string; readonly args: number[] }[] {
...
/** Pontos que o comando visita, já em coordenadas absolutas, mais o novo ponto corrente. */
function pointsOf(
  cmd: string,
 ...
 */
function arcPoints(from: Point, end: Point, args: readonly number[]): readonly Point[] {
